...
*/
uint64_t ReadStatic::level_get[] = {0}; 
uint64_t ReadStatic::table_get = 0;
uint64_t ReadStatic::table_bloomfilter_miss = 0;
uint64_t ReadStatic::table_readfile_miss = 0;
